...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const target = windowEvents ? window : renderer.domElement;
    ...
    return () => {
      destroyTimeoutRef.current = window.setTimeout(() => {
        ...
        if (t.onPointerDown)
          target.removeEventListener("pointerdown", t.onPointerDown);
        if (t.onPointerMove)
          target.removeEventListener("pointermove", t.onPointerMove);
        t.resizeObserver?.disconnect();
        cancelAnimationFrame(t.raf!);
        t.quad?.geometry.dispose();
        t.material.dispose();
