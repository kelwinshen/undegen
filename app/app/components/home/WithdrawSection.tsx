      ...
      <div>
        {!isConnected ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Yield Lottery: no on-chain instruction exists for this yet, disabled rather than faked */}
            <button
              disabled
              title="Not yet implemented on-chain"
              className="py-3 px-6 border border-border-low font-medium rounded-xl text-xs tracking-wider uppercase opacity-40 cursor-not-allowed flex items-center justify-center gap-2 text-foreground"
            >
              <span>Yield Lottery (Coming Soon)</span>
            </button>
          </div>
        ) : (
